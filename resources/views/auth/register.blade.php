...
<head>
  <meta charset="utf-8">
    ...
    <title>Sunny Admin - Register </title>
                            ...
                            @csrf
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input id="name" type="text" name="name" value="{{old('name')}}"   class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Full Name">
                                    </div>
                                        @error('name')
											<div class="text-danger ml-5" >{{ $message }}</div>
										@enderror
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="email" name="email" value="{{old('email')}}" id="email" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Email">
                                    </div>
                                        @error('email')
											<div class="text-danger ml-5" >{{ $message }}</div>
										@enderror
